<table id="rooms-table" class="table table-dark  shadow mb-5 mt-3 hype-unselectable hype-table-clickable">
    <thead>
        <tr>
            ...
            <th scope="col" class="d-none d-xl-table-cell">Poster</th>
            <th scope="col" class="d-none d-xl-table-cell">Locandina</th>
    ...
    <tbody>
        @foreach ($movies as $movie)
            <tr>
                ...
                <td class="d-none d-xl-table-cell"><a>{{ $movie->poster_path }}</a></td>
                <td class="d-none d-xl-table-cell"><a>{{ $movie->backdrop_path }}</a></td>
                ...
                <td>
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('admin.movies.show', $movie->id) }}" class="table-icon m-1">
                            <div class="icon-container">
                                <i
                                    class=" fa-solid fa-eye fs-3 text-active-tertiary hype-text-shadow hype-hover-size"></i>
                            </div>
                        </a>
                        <a href="{{ route('admin.movies.edit', $movie->id) }}" class="table-icon m-1">
                            <div class="icon-container">
                                <i
